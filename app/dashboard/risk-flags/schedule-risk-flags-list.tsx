...
import type { RiskSeverity, ScheduleRiskFlag } from '@/lib/supabase/types'
...
function RiskFlagCard({ flag }: { flag: ScheduleRiskFlag }) {
  return (
...
export function RiskFlagsSection({ flags }: { flags: ScheduleRiskFlag[] }) {
