...
export async function getDashboardSummary(
  ...
  // The financial risk_flags table (QuickBooks-derived) only applies to
  // Finance; other fields have their own schedule_risk_flags pipeline
  // (see app/dashboard/risk-flags) surfaced separately, not in this KPI
  // tile — skip the extra queries here, same guard as getUnreadAlertCount's
  // caller in layout.tsx.
